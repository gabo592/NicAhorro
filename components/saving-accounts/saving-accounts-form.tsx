...
import { SavingAccount, SavingAccountEntity } from '@/types/saving-account';
...
import { createSavingAccount, updateSavingAccount } from '@/app/saving-accounts/actions';
...
interface SavingAccountsFormProps {
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Proporciona información adicional, por ejemplo, el propósito de la Cuenta de Ahorro.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent>
                  {currencies.map((currency) => (
                    <SelectItem key={currency.id} value={currency.id}>{currency.iso3_code}</SelectItem>
                  ))}
                </SelectContent>
              </Select>
              <FormDescription>
                La moneda indica la magnitud del dinero guardado en una Cuenta de Ahorro.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
